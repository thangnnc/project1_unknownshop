...
public final class DialogWelcome extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblAo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Shop.gif"))); // NOI18N
        jPanel1.add(lblAo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 490));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogWelcome dialog = new DialogWelcome();
