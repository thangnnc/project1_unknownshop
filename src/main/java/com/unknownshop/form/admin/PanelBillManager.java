...
public class PanelBillManager extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnHDChiTiet.setToolTipText("HoaDon");
        ...
        pnlTabButtonLayout.setVerticalGroup(
            ...
            .addGroup(pnlTabButtonLayout.createSequentialGroup()
                .addGroup(pnlTabButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlTabButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnHDChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btnDSHoaDonXN, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnDanhSachHD, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        if (tblDSHoaDonXN.getColumnModel().getColumnCount() > 0) {
            ...
            tblDSHoaDonXN.getColumnModel().getColumn(0).setPreferredWidth(200);
            tblDSHoaDonXN.getColumnModel().getColumn(1).setResizable(false);
            tblDSHoaDonXN.getColumnModel().getColumn(1).setPreferredWidth(150);
            tblDSHoaDonXN.getColumnModel().getColumn(2).setResizable(false);
            tblDSHoaDonXN.getColumnModel().getColumn(2).setPreferredWidth(400);
            tblDSHoaDonXN.getColumnModel().getColumn(3).setResizable(false);
            tblDSHoaDonXN.getColumnModel().getColumn(3).setPreferredWidth(150);
